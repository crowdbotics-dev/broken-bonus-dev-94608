"""
Django settings for broken_bonus_dev_94608 project.
...
ROOT_URLCONF = 'broken_bonus_dev_94608.urls'
...
WSGI_APPLICATION = 'broken_bonus_dev_94608.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "broken_bonus_dev_94608 API",
    "DESCRIPTION": "API documentation for broken_bonus_dev_94608 App",
    "VERSION": "v1",
}
